...
\hypersetup{
  ...
  urlcolor=deepblue,
  citecolor=deepblue,
  pdftitle={A High-School Friendly Tutorial on the Cell2location Bayesian Model v3},
  pdfauthor={OpenAI},
...
\end{tcolorbox}
\vfill
{\large Prepared as a learning guide for a high school student\\Version 3}\par
\vspace{0.3in}
{\large \today}\par
\end{titlepage}
...
This tutorial explains the Bayesian model described in the Methods section, especially page 12, of Kleshchevnikov et al., \emph{Cell2location maps fine-grained cell types in spatial transcriptomics}, \emph{Nature Biotechnology} 40, 661--671 (2022). The tutorial is written as an educational paraphrase with simplified examples and diagrams. The new prior-distribution section also uses the public cell2location documentation and source-code math description to explain the internal Gamma and Exponential prior structure in beginner-friendly language.
