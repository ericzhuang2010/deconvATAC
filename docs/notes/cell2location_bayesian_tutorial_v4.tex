...
\hypersetup{
  ...
  urlcolor=deepblue,
  citecolor=deepblue,
  pdftitle={A High-School Friendly Tutorial on the Cell2location Bayesian Model v4},
  pdfauthor={OpenAI},
...
\end{tcolorbox}
\vfill
{\large Prepared as a learning guide for a high school student\\Version 4}\par
\vspace{0.3in}
{\large \today}\par
\end{titlepage}
